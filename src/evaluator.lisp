...
(defun make-comparison-func (tok)
  (cond
    ((string= tok ">")
     (lambda (a b) (if (and (stringp a) (stringp b)) (and (string> a b) t) (> a b))))
    ((string= tok "<")
     (lambda (a b) (if (and (stringp a) (stringp b)) (and (string< a b) t) (< a b))))
    ((string= tok "=")
     (lambda (a b) (if (and (stringp a) (stringp b)) (string= a b) (= a b))))
    ((string-equal tok ">=")
     (lambda (a b) (if (and (stringp a) (stringp b)) (not (string< a b)) (>= a b))))
    ((string-equal tok "<=")
     (lambda (a b) (if (and (stringp a) (stringp b)) (not (string> a b)) (<= a b))))
    ((string-equal tok "!=")
     (lambda (a b) (if (and (stringp a) (stringp b)) (not (string= a b)) (not (= a b)))))))
